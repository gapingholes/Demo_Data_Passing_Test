...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonInteger = findViewById(R.id.buttonInteger);
        buttonCharacter = findViewById(R.id.buttonCharacter);
        textDouble = findViewById(R.id.textDouble);


    buttonInteger.setOnClickListener(new View.OnClickListener() {
    @Override
